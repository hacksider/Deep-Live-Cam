...
def parse_args() -> None:
    ...
    audio_group = program.add_mutually_exclusive_group()
    audio_group.set_defaults(keep_audio=True)
    audio_group.add_argument('--keep-audio', help='keep original audio', dest='keep_audio', action='store_true')
    audio_group.add_argument('--no-keep-audio', help='disable restoring original audio', dest='keep_audio', action='store_false')
